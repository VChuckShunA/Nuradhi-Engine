...
namespace lve {
	...
	void lve::LveCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far)
	{
	...
	{
		//construct an ortho-normal basis. Used to construct a rotation matrix
	...
	{
		//TODO: Make sure direction is non zero
