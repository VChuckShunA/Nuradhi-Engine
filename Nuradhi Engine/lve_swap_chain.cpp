...
namespace lve {
    ...
    LveSwapChain::LveSwapChain(LveDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<LveSwapChain> previous)
        : device{ deviceRef }, oldSwapChain{previous}
    {
        init();
        //clean up old swap chain since its no longer needed
        //we will only use old swap chain during initialization
    ...
    VkPresentModeKHR LveSwapChain::chooseSwapPresentMode(
        ...
        //Comment out the below below block to use VSync at all times
